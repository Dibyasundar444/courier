...
import { Ionicons, FontAwesome, SimpleLineIcons, Foundation, FontAwesome5 } from '@expo/vector-icons';
import PickUPScreen from "./PickUp";
import DropScreen from "./Drop";
import FoodInfoScreen from "./FoodInfo";
        ...
        <View style={styles.container}>
            <View style={{marginTop:40,flexDirection:"row",alignItems:"center",marginLeft:15}}>
                ...
                <View style={{flex:1,alignItems:"center"}}>
                   ...
                   {activeIndex === 2 ? <Text style={{color:"#fff",fontSize:28}}>Food Info</Text> : null}
            ...
            <View style={{flexDirection:"row"}}>
                <View style={{alignItems:"center",flex:0.25}}>
                    ...
                    onPress={()=>segmentClicked(2)} active={activeIndex == 2}>
                        <FontAwesome5 name="utensil-spoon" color={"#eda81c"} size={20} />
                    </TouchableOpacity>
