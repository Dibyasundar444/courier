...
export default function ConfirmInfoScreen(){
    ...
    return(
        <ScrollView style={{marginBottom:100}} showsVerticalScrollIndicator={false}>
            ...
            <View style={{marginLeft:20,marginRight:10}}>
                ...
                <View style={{flexDirection:"row",justifyContent:"space-between"}}>
                    ...
                    <View style={{flexDirection:"row"}}>
                        ...
                        <Text style={{color:"#eda81c",fontWeight:"bold"}}>View in Map</Text>
                    </View>
                </View>
            </View>
            <View style={{borderWidth:3,borderColor:"#e8e4e3",marginVertical:20}}/>
            <View style={{marginLeft:20}}>
                <View>
                    <View style={{flexDirection:"row",justifyContent:"space-between",marginRight:30}}>
                        ...
                        <Text style={{color:"gray"}}>Frangible</Text>
                    </View> 
            ...
            <TouchableOpacity style={{marginHorizontal:20,backgroundColor:"#e8e4e3",borderRadius:30}}>
